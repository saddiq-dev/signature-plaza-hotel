...
public class SearchBooking extends JFrame implements ActionListener 
{
    ...
    public void searchBooking(String user) 
    { 
            ...
            try 
            {
                try
                {
                    if(!s1.equals("") )
                    {
                        ...
                        String[] vbinfo = new String[6];
                        vbinfo[0] = s1;
                        vbinfo[1] = passedInfo[1];
                        vbinfo[2] = s2;
                        vbinfo[3] = s3;
                        vbinfo[4] = s4;
                        vbinfo[5] = s5;
                        vb.viewBooking(vbinfo);
                        setVisible(true);
                        this.dispose();
                    }
                }
